 ...
 * Professional implementation matching ESP-IDF patterns
 */
...
esp_err_t ethernet_w5500_init(void) {
    ...
    // Extended delay for clone chips that may need more time
    ESP_LOGI(TAG, "Waiting 500ms for W5500 chip stabilization...");
